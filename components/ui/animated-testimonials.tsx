                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    >
                        <h3 className="text-2xl font-bold dark:text-white text-black">
                            {testimonials[active]?.name || "No Name Available"}
                        </h3>
                        <p className="text-sm text-gray-500 dark:text-neutral-500">
                            {testimonials[active]?.role || "No Role Specified"}
                        </p>
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="h-7 w-7 bg-gray-100 dark:bg-neutral-800 flex items-center justify-center group/button"
                        >
